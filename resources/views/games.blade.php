...
<div class="card card-image mt-5" style="background-image: url('{{asset('frontend/img/header-bg.jpg')}}');">
  <div class="text-white text-center rgba-stylish-light py-5 px-4">
    <div class="py-5">
      ...
      <!-- Content -->
      <h1 class="card-title h1 my-5 py-2 text-uppercase font-weight-bold">Games</h1>
    </div>
  </div>
</div>
<!-- Jumbotron -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-12 mb-5">
                            ...
                            <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                            <p class="dark-grey-text"><a href="/games">Default</a></p>
                            <p class="dark-grey-text"><a href="{{route('games.index',['query'=>request()->input('query'),'sort'=>'low_high'])}}">Rating: low to high</a></p>
                            <p class="dark-grey-text"><a href="{{route('games.index',['query'=>request()->input('query'),'sort'=>'high_low'])}}">Rating: high to low</a></p>
                        </div>
